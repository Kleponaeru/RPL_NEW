                            ...
                            <div class="col-sm-10">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="jam"
                                        id="inlineRadio1" value="08.00" value="08.00" {{ ($n->jam == '08.00') ? 'checked':''}}>
                                    <label class="form-check-label" for="inlineRadio1">08.00</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="jam"
                                        id="inlineRadio2" value="09.30" value="09.30" {{ ($n->jam == '09.30') ? 'checked':''}}>
                                    <label class="form-check-label" for="inlineRadio2">09.30</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="jam"
                                        id="inlineRadio3" value="11.30" value="11.30" {{ ($n->jam == '11.30') ? 'checked':''}}>
                                    <label class="form-check-label" for="inlineRadio3">11.30</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="jam"
                                        id="inlineRadio4" value="13.30" value="13.30" {{ ($n->jam == '13.30') ? 'checked':''}}>
                                    <label class="form-check-label" for="inlineRadio4">13.30</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="jam"
                                        id="inlineRadio5" value="15.30" value="15.30" {{ ($n->jam == '15.30') ? 'checked':''}}>

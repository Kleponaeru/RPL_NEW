...
<div class="flex items-center">
    ...
    <div class="bg-white p-6 rounded-md shadow-md mb-4 mr-4">
        ...
        <button class="bg-blue-500 text-white px-4 py-2 rounded-md" onclick="showConfirmation('Basic Plan', 'Rp 15.000/month')">Subscribe</button>
    </div>
    ...
    <div class="bg-white p-6 rounded-md shadow-md mb-4 mr-4">
        ...
        <button class="bg-blue-500 text-white px-4 py-2 rounded-md" onclick="showConfirmation('Standard Plan', 'Rp 30.000/month')">Subscribe</button>
    </div>
    ...
    <div class="bg-white p-6 rounded-md shadow-md mb-4">
        ...
        <button class="bg-blue-500 text-white px-4 py-2 rounded-md" onclick="showConfirmation('Premium Plan', 'Rp 60.000/month')">Subscribe</button>
    </div>
</div>
...
<div id="confirmationModal" class="modal">
    <div class="modal-content">
        <p>Are you sure you want to subscribe to the <span id="planName"></span> plan for <span id="planPrice"></span>?</p>
